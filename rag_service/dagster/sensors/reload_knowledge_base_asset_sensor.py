                        ...
                        "ops": {
                            reload_knowledge_base_asset.node_def.name: {
                                "ops": {
                                    ...
                                    delete_kba_database_vector_store.name: {"config": {"job_id": str(job.id)}},
                                    fetch_raw_document.name: {"config": {"job_id": str(job.id)}},
                                    save_delayed_detection_document_data.name: {"config": {"job_id": str(job.id)}},
                                    save_document_metadata.name: {"config": {"job_id": str(job.id)}},
